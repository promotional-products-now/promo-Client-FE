...
export class AutocompleteNode extends DecoratorNode<JSX.Element | null> {
  ...
  updateDOM(_a: unknown, _b: HTMLElement, _c: EditorConfig): boolean {
    return false;
  }

  createDOM(__format: EditorConfig): HTMLElement {
    return document.createElement("span");
  }

  decorate(_: LexicalEditor, config: EditorConfig): JSX.Element | null {
    if (this.__uuid !== UUID) {
      return null;
    }
