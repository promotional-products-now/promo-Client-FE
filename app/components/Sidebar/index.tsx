...
export const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className={`fixed w-4/5 left-0 top-0 z-[1000] flex flex-col items-start justify-start overflow-y-clip bg-[#f5f6fa] transition-transform duration-300 ease-linear dark:bg-dark lg:static lg:translate-x-0 h-screen ${
