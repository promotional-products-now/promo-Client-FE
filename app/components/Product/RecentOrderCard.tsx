  ...
  return (
    <div className="border  border-lightGray p-6 flex flex-wrap justify-between items-center gap-3 mb-4">
      <div className="flex gap-4 items-center">
        <Image className="rounded-none" width={150} alt="product image" src={props.productImg} />
      ...
      <Divider orientation="vertical" className="bg-lightGray w-px  h-16" />
      <div>
      ...
      <div>
        <Button
          ...
          radius="none"
          className="text-lg"
          startContent={<GrCart className="text-white text-xl" />}
        >
          View Product
        </Button>
      </div>
