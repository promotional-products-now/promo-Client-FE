      ...
      <div className='py-4 md:py-8'>
        ...
        <div className='grid  grid-cols-1  md:grid-cols-3  gap-4 py-4 px-2 md:px-6 w-full md:w-5/6 mx-auto'>
            ...
            <div>
              <div className='flex gap-3 py-3'>
                ...
                <div className='space-y-2'>
                  ...
                  <Link to="#" className='text-base text-yellow'>Edit account info</Link>
                </div>
              </div>
              ...
              <div className='flex  gap-3 py-3'>
                ...
                <div className='space-y-2'>
                  <p>*********</p>
                  <Link to="/change-password" className='text-base text-yellow'>Change Password</Link>
                </div>
              </div>
              <div className='flex gap-3 py-3'>
          ...
          <div className='col-span-2'>
            <h1 className='text-dark text-lg md:text-xlx'>Your Recent Orders</h1>
